...
const transactionsData: TransactionData = {
  ...
  style: { line: 'red' },
  x: [
    '00:00', '00:05', '00:10', '00:15', '00:20', '00:30', '00:40', '00:50', '01:00',
...
const transactionsData1: TransactionData = {
  title: 'Europe',
  style: { line: 'yellow' },
  x: [
    '00:00', '00:05', '00:10', '00:15', '00:20', '00:30', '00:40', '00:50', '01:00',
...
function generateMockTransactionsData(mockData: TransactionData[]): TransactionData[] {
  for (const data of mockData) {
    const last = data.y[data.y.length - 1];
    data.y.shift();
...
export class TransactionsService {
  readonly transactions$: Observable<TransactionData[]> = interval(750).pipe(
